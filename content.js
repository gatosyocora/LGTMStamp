$(function() {
    $('.flex-justify-end div:nth-child(2)').before("<input type='button' class='btn btn-primary ml-1' value='LGTM' id='lgtm-button'>");
    ...
    $(document).on("click", "#lgtm-button", function(){
        ...
        $('.flex-justify-end div:nth-child(3) button').prop('disabled', false);
    });
});